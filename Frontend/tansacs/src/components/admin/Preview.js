          ...
          <div className="w-full my-3 ">
            ...
            <div className="lg:w-1/2 w-full my-5 flex flex-col gap-5">
              <div className="flex w-full justify-center items-center text-sm font-bold gap-3">
                ...
                <p className="w-1/2 text-start box-shadow rounded-md text-sm font-bold p-2">{data.data.pexp[0]?.year ? data.data.pexp[0].year : 0} </p>
              </div>
              <div className="flex w-full justify-center items-center gap-3">
                <p className="w-1/2 text-start text-sm font-bold">TANSAC EXPERENCE :</p>
                <p className="w-1/2 text-start box-shadow rounded-md text-sm font-bold p-2">{data.data.pexp[1]?.year ? data.data.pexp[1].year : 0}</p>
              </div>
              <div className="flex w-full justify-center items-center gap-3">
                <p className="w-1/2 text-start text-sm font-bold">TSU EXPERENCE</p>
                <p className="w-1/2 text-start box-shadow rounded-md text-sm font-bold p-2">{data.data.pexp[2]?.year ? data.data.pexp[2].year : 0}</p>
              </div>
