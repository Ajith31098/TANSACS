    ...
    return ( 
        ...
        <div className="grid grid-cols-5 mt-5 gap-20">
            ...
            <div className="col-span-5 flex flex-col justify-center items-center">
                ...
                <a href="#" className='text-red-600 font-semibold text-xl my-5'>TANSACS Recruitment Eligibility Criteria.pdf</a>
                
                <p className='text-red-600 font-semibold mb-3 text-xs'>Note:In  below TANSACS Job Posting Details are given please read before apply</p>
                <p className='font-bold text-sm'>JOB POSTING WILL BE ALLOCATED PURELY BASED ON THE CRITERIA</p>
