...
function AssistantDirectorTI() {
    ...
    return(
        ...
        <CommForm position= "Assistent Director (TI)"   ug = {AssistantDirector_Prevention_ug} pg={AssistantDirector_Prevention_pg} exp = {AssistantDirector_Prevention_experience} />
    )
