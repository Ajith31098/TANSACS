...
urlpatterns = [
    ...
    path('setpassword_user/<str:email>',
         views.SetPassword.as_view(), name="set_password"),
    path('download_file/<str:file_name>',
         views.download_file, name='download_file'),
    path('get_detail', views.JobVerification.as_view(), name='get_detail'),
    path('download_success_pdf/<int:pk>',
         views.download_success_file, name="download_success_pdf")
